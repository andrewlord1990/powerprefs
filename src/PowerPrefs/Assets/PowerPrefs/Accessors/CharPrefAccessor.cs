namespace PowerPrefs {
  ...
  public class CharPrefAccessor : PrefAccessor<char> {
    ...
    /// The default value to return if the key doesn't exist. If not specified it will be the default char.
    /// </param>
    /// <returns>The char value stored at the key prefKey or if not present then the default char.</returns>
